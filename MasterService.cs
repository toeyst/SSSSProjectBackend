...
namespace Service
{
    public interface IMasterService
    {
        ...
        Task<List<ProductDetail>> GetAllProduct();
    }
    ...
    .ToList();
        ...
        //}
        public async Task<List<ProductDetail>> GetAllProduct()

        {
            var allproduct = await _sSSSProjectContext.ProductDetail.Select(s => new ProductDetail
            {
                ProductId = s.ProductId,
                ProductColor = s.ProductColor,
                ProductName = s.ProductName,
